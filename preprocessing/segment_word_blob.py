...
import numpy as np
import os 
from skimage.feature import blob_log # Blob_log is used for blob detection in an image.
...
blobs_log = blob_log(image_gray, max_sigma=10, num_sigma=25, threshold=.01) # List of blobs in an image. 
