...
def segmentation_call(image):
	rootdir = 'web_app/hwrkannada/hwrapp/static/hwrapp/images/Processed_' + os.path.splitext(ntpath.basename(image))[0]
...
def augmentation_call(image, rootdir):
	augdir = rootdir + '/Augmented_' + os.path.splitext(ntpath.basename(image))[0]
