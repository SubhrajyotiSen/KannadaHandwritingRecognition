...
urlpatterns = [
	...
	path('results/linesegments/<int:image_id>', views.linesegments, name='linesegments'),
	# /hwrapp/results/wordsegments/image_id
	path('results/wordsegments/<int:image_id>', views.wordsegments, name='wordsegments'),
	# /hwrapp/results/charsegments/image_id
	path('results/charsegments/<int:image_id>', views.charsegments, name='charsegments'),
